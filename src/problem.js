...
function concatenateArrays() {
    ...
    var result = [];
    arrays.forEach(function (arr) { return result.push.apply(result, arr); });
    return result;
}
...
var myCar = new Car("Honda", 2024, "Dream 110");
...
function getMostExpensiveProduct(products) {
    if (products.length === 0)
        return null;
    return products.reduce(function (maxSoFar, current) {
        return current.price > maxSoFar.price ? current : maxSoFar;
    });
}
var products = [
    { name: "Pen", price: 10 },
